...
import { ThumbsUp, ThumbsDown, Clock, DollarSign, Star, ChevronRight } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="p-5 space-y-3">
        ...
        {/* View details hint */}
        <div className="flex items-center justify-end pt-1 text-xs text-primary font-medium">
          View details
