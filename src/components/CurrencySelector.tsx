...
export function CurrencySelector() {
  ...
  return (
    <select
      ...
      className="appearance-none px-3 py-1.5 pr-6 rounded-full border border-border text-sm font-medium text-foreground bg-transparent hover:bg-muted transition-colors cursor-pointer outline-none"
      style={{
