...
export function SignInModal({ isOpen, onClose, reason, onBeforeSignIn }: SignInModalProps) {
  ...
  const description =
    reason === "search_limit"
      ? "Sign in to keep exploring unlimited destinations and save your favorites."
      : "Create a free account to save destinations and build your travel wishlist.";
  const Icon = reason === "search_limit" ? Search : Heart;
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 pointer-events-none">
        <div className="bg-card border border-border rounded-2xl shadow-xl max-w-sm w-full p-8 text-center pointer-events-auto relative">
          <button
            onClick={onClose}
