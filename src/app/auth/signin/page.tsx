...
export default async function SignInPage({
  ...
  const redirectTo = callbackUrl || "/explore";
      ...
      <div className="auth-form-panel">
        ...
        <div className="auth-form-content">
          ...
          <div className="auth-buttons">
            <a href={`/api/auth/login?provider=google&callbackUrl=${encodeURIComponent(redirectTo)}`} className="auth-btn">
            ...
            <a href={`/api/auth/login?provider=github&callbackUrl=${encodeURIComponent(redirectTo)}`} className="auth-btn">
